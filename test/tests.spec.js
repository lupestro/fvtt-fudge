...
test.beforeAll(async ({browser})=>{
  ...
  if(gmPage.url().includes("/setup")){
    let section = await gmPage.locator('[data-package-id="fudge-playtesting"]');
  ...
  await gmPage.locator("input[name=password]").fill(process.env.TEST_GM_PASSWORD ? process.env.TEST_GM_PASSWORD : '');
